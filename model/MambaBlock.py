...
class MambaBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv33conv33conv11 = nn.Sequential(
            nn.Conv2d(hidden_dim // 2, hidden_dim // 2, kernel_size=3, padding=1, groups=hidden_dim // 2),  # Depthwise
            nn.BatchNorm2d(hidden_dim // 2),
            nn.ReLU(),
            nn.Conv2d(hidden_dim // 2, hidden_dim // 2, kernel_size=1),  # Pointwise
            nn.BatchNorm2d(hidden_dim // 2),
            nn.ReLU(),
            SqueezeExcitation(hidden_dim // 2)
        )
...
if __name__ == '__main__':
    ...
    block = MambaBlock(hidden_dim=128).to(device)
